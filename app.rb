...
class App
  ...
  def list_books
    puts 'Sorry, there are no books available. Add some books and try again!' if @books.empty?
  ...
  def list_people
    puts 'No people added yet, please add a person and try again!' if @people.empty?
